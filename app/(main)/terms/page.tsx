...
export const metadata: Metadata = {
  title: 'ข้อกำหนดการใช้งาน - WeXPlus',
  description: 'ข้อกำหนดการใช้งานของ WeXPlus - กฎและเงื่อนไขในการใช้บริการ',
};
...
export default async function TermsPage() {
  const { settings, items, updateDate } = await getTermsData();
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 md:p-8 lg:p-10">
              ...
              {items.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-400 text-lg mb-2">ยังไม่มีเนื้อหาข้อกำหนดการใช้งาน</p>
