...
const PublicProductsSearch = dynamicImport(() => import('@/components/PublicProductsSearch'), {
  loading: () => (
...
const ProductsBreadcrumb = dynamicImport(() => import('@/components/ProductsBreadcrumb'), {
  ssr: true,
});
