...
export async function GET(req: Request) {
  try {
    ...
    try {
      ...
      console.error('[GET /api/mtopup] Error fetching global markup:', markupErr);
    }
    ...
    if (perr) {
      console.error('[GET /api/mtopup] Error fetching products:', perr);
    ...
    if (ierr) {
      console.error('[GET /api/mtopup] Error fetching product_items:', ierr);
    ...
    if (orderErr) {
      console.error('[GET /api/mtopup] Error fetching orders:', orderErr);
    }
    ...
    console.error('[GET /api/mtopup] Unexpected error:', err);
    return NextResponse.json({ 
      error: 'unexpected', 
