...
async function performSync(providerId: number | null) {
...
export async function POST(req: Request) {
  ...
  try {
    ...
    const providerId = body.provider_id ? parseInt(String(body.provider_id)) : null;
    
    // เรียก internal function แทน external fetch
    return await performSync(providerId);
  } catch (err) {
