    ...
    <>
      ...
      <Dialog open={loginOpen} onOpenChange={(open) => {
        ...
        <DialogContent className="sm:max-w-[480px] bg-white border-0 shadow-2xl p-0 overflow-hidden">
          ...
          {/* Form */}
          <form onSubmit={onLoginSubmit} className="px-8 py-6 space-y-5">
            <div className="space-y-2">
              <Label htmlFor="username" className="text-gray-800 font-medium text-sm">ชื่อผู้ใช้หรืออีเมล</Label>
              <Input 
                id="username" 
                value={username} 
                ...
                required 
                className="bg-gray-50 border-gray-200 text-gray-900 placeholder:text-gray-400 focus:border-emerald-500 focus:ring-emerald-500/20 h-11 rounded-lg"
              />
            </div>
            <div className="space-y-2">
              <Label htmlFor="password" className="text-gray-800 font-medium text-sm">รหัสผ่าน</Label>
              <Input 
                id="password" 
                type="password" 
                value={password} 
            ...
            <div className="flex gap-3 pt-4 border-t border-gray-100">
              <button
                ...
                className="flex-1 inline-flex items-center justify-center border-2 border-emerald-600 bg-white text-emerald-600 hover:bg-emerald-50 hover:border-emerald-700 hover:text-emerald-700 h-11 rounded-lg font-semibold transition-colors"
              >
      ...
      <Dialog open={registerOpen} onOpenChange={(open) => {
        ...
        <DialogContent className="sm:max-w-[480px] bg-white border-0 shadow-2xl p-0 overflow-hidden">
          ...
          {/* Form */}
          <form onSubmit={onRegisterSubmit} className="px-8 py-6 space-y-5">
            <div className="space-y-2">
              <Label htmlFor="reg-username" className="text-gray-800 font-medium text-sm">ชื่อผู้ใช้</Label>
              <Input 
                id="reg-username" 
                value={username} 
                onChange={(e) => setUsername(e.target.value)} 
            ...
            <div className="space-y-2">
              <Label htmlFor="reg-password" className="text-gray-800 font-medium text-sm">รหัสผ่าน</Label>
              <Input 
                id="reg-password" 
                type="password" 
                value={password} 
            ...
            <div className="space-y-2">
              <Label htmlFor="reg-repassword" className="text-gray-800 font-medium text-sm">ยืนยันรหัสผ่าน</Label>
              <Input 
                id="reg-repassword" 
                type="password" 
                value={repassword} 
